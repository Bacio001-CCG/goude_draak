<div class="flex justify-between items-center flex-wrap w-full md:px-20">
    ...
    <div class="flex flex-row items-center right-1">
        <a href=""
            class="relative inline-flex items-center px-4 py-2 mr-2 text-sm font-medium text-[#ffff00] border border-[#ffff00] rounded-md hover:opacity-75 focus:outline-none">
            <span>EN</span>
            <span
        ...
        <a href=""
            class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-[#ffff00] border border-[#ffff00] rounded-md hover:opacity-75 focus:outline-none">
            <span>NL</span>
            <span
