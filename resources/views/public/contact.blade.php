...
@section('content')
    <div class="bg-[#fffaf0] flex items-center flex-col border-[1px] border-black text-center p-8 *:max-w-4xl">
        <p>
            {{ __('public.LocationInstructions') }}<br><br>
            {{ __('public.Adres') }}<br>
            {{ __('public.Postalcode') }}
        </p>
    </div>
    <iframe 
